...
{
  "'XOR' r,R", // XOR src, dst
  "'XOR' #u,r,R", // XOR k8, src, dst
  "'XOR' #u,r,R", // XOR k16, src, dst
  "'XOR' s,r,R", // XOR Smem, src, dst
  "'XOR' r<<#n,R", // XOR ACx << #SHIFTW[, ACy]
...
static void execute(struct _PipeLine *pipeP, struct _Registers *Reg)
{
  ...
  switch ( pipeP->opcode_subType )
    ...
    case 7:
      ...
      // fixme? XOR #0xfff,*ar1+ should EAB=DAB ?
