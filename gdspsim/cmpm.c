...
static gchar *mask[]=    { "01100000 aaaaaaaa nnnnnnnn nnnnnnnn" };
static gchar *opcode[] = { "CMPM a,#n" };
static gchar *comment[]= { "TC=$(n) == $(a)" };

/* This definition is global because another routine will make have
 * an array that points to all the different instruction classes.
 */
Instruction_Class CMPM_Obj =
{
  "CMPM",
  NULL, // prefetch
  NULL, // fetch
...
static void read_stg2(struct _PipeLine *pipeP, struct _Registers *Reg)
{
  ...
  // Not sure if this happens at the right point in the pipeline
  if ( pipeP->word_number == 1 )
    {
