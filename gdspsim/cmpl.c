...
static gchar *mask[]=    { "111101sd 10010011" };
static gchar *opcode[] = { "CMPL s,d" };
static gchar *comment[]= { "$(d) == $(s) ^ 0xffff" };

/* This definition is global because another routine will make have
 * an array that points to all the different instruction classes.
 */
Instruction_Class CMPL_Obj =
{
  "CMPL",
  NULL, // prefetch
  NULL, // fetch
...
static void execute(struct _PipeLine *pipeP, struct _Registers *Reg)
{
  ...
  reg_union.guint64 = reg_union.guint64 | 0xffffffff;
